...
function initWorld_ThreeJS()
{
    ...
    directionalLight = new THREE.DirectionalLight( 0xFF0099, 1.3 );
    directionalLight.position.set( 0, -25, -5 );
    directionalLight.target.position.set( 0, 0, 0 );
    directionalLight.castShadow = true;
    directionalLight.shadow = new THREE.LightShadow( new THREE.PerspectiveCamera( 10, 1, 1200, 2500 ) );
...
/*
        material = new THREE.PointsMaterial( { size: 35, sizeAttenuation: false,  transparent: true } );
...
*/
        ...
        wireframe = new THREE.WireframeHelper( meshPlane, 0x6700b0 );
        //scene.add( wireframe );
            ...
            while( i < intersects.length )
            {
              ...
              //  TweenMax.fromTo(faces[intersects[i].faceIndex+2].color, 0.5, {r : 2,g :2, b : 2},{r : 1,g :1, b : 1}) 
                ...
                if( intersects[i].distance > 30 )
                {
                    ...
                    TweenMax.to( tempA, 0.8, { y : tempA.originalY, delay: 0.5, ease: Elastic.easeOut } )
                    TweenMax.to( tempB, 0.8, { y : tempB.originalY, delay: 0.5, ease: Elastic.easeOut } )
                    TweenMax.to( tempC, 0.8, { y : tempC.originalY, delay: 0.5, ease: Elastic.easeOut } )
